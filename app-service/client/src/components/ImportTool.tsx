    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex sm:items-center sm:justify-center p-0 sm:p-4">
      <div className="max-w-md w-full bg-matrix-light sm:border border-white/10 sm:rounded-2xl p-6 sm:p-8 space-y-6 shadow-2xl overflow-hidden h-full sm:h-auto sm:max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between shrink-0">
          <h2 data-testid="import-modal-title" className="text-2xl font-bold">
            Import System
          </h2>
          <button
            ...
            <div className="space-y-6">
              ...
              <div className="border-2 border-dashed border-white/10 rounded-xl p-8 text-center hover:border-matrix-primary/50 transition-colors relative group">
                ...
                <div className="space-y-2 pointer-events-none">
                  <Upload
                    className="mx-auto text-matrix-muted group-hover:text-matrix-primary transition-colors"
                    size={40}
                  />
          ...
          {status === 'success' && (
            <div className="py-6 text-center space-y-6">
              <div className="space-y-2">
                ...
                <h3 data-testid="import-success-header" className="text-xl font-bold">
                  Import Successful!
                </h3>
                <p data-testid="import-success-message" className="text-matrix-muted">
              ...
              {failedAvatars.length > 0 && (
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 text-left space-y-3">
                  ...
                  <p className="text-[10px] text-amber-500/70 leading-relaxed">
                    These members were imported, but their avatar images either could not be loaded or did not meet the
                    requirements (under 1MB, smallest axis &lt; 1000px, .jpg/.png/.webp). You can update them manually
                    in their profile.
                  </p>
                  ...
                  <button onClick={() => onComplete(systemSlug)} className="matrix-button w-full py-2 text-xs">
                    Got it, Finish
                  </button>
                </div>
              )}
