...
const MemberCard: React.FC<MemberCardProps> = ({
  ...
  return (
    ...
    >
      <div className="h-2 w-full" style={{ backgroundColor: member.color ? `#${member.color}` : '#0dbd8b' }} />
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 data-testid="member-card-name" className="text-xl font-bold flex items-center gap-2">
                ...
                {isAutoproxy && (
                  <span className="bg-yellow-500/20 text-yellow-500 text-[10px] uppercase font-bold px-2 py-0.5 rounded flex items-center gap-1 shrink-0">
                    <Star size={10} fill="currentColor" /> Autoproxy
                  </span>
                )}
              </h3>
