      ...
      <div className="bg-slate-900 w-full max-w-2xl h-full sm:h-auto sm:max-h-[80vh] sm:rounded-2xl border-0 sm:border border-slate-800 shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-4 border-b border-slate-800 flex justify-between items-center bg-slate-800/50">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-slate-100" data-testid="dlq-modal-title">
              Dead Letter Vault
            </h2>
            <span className="bg-slate-700 text-slate-300 text-xs px-2 py-0.5 rounded-full">{letters.length}</span>
          </div>
          <div className="flex items-center gap-2">
            <button
              ...
              {letters.map((letter) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-slate-300 text-sm truncate font-medium">{letter.plaintext}</p>
                  </div>
