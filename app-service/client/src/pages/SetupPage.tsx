          ...
          <>
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-5 space-y-4">
              ...
              <div className="space-y-3 text-sm text-matrix-muted">
                <p>
                  <strong className="text-white">Public Profiles:</strong> All system and member metadata is publicly
                  accessible. Do not store private info in your profiles.
                </p>
                <p>
                  <strong className="text-white">Message Content:</strong> Your messages are not public, but using
                  plural_bot in encrypted rooms allows the <strong>homeserver administrator</strong> to read them.
                </p>
                <p>
                  <strong className="text-white">Data Control:</strong> We don't use tokens. Use the web UI to export
                  your data regularly for backups or to move servers.
                </p>
              </div>
            </div>
