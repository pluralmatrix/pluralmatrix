...
describe('GatekeeperController', () => {
  ...
  const mockSystem = {
    id: 'sys1',
    slug: 'seraphim',
    members: [{ id: 'm1', slug: 'lily', name: 'Lily', proxyTags: [{ prefix: 'lily:', suffix: '' }] }],
  };
