...
describe('importController', () => {
  ...
  describe('exportPluralKitZip', () => {
    it('should trigger ZIP export successfully', async () => {
      ...
      expect(jest.spyOn(mockRes, 'setHeader')).toHaveBeenCalledWith(
        'Content-Disposition',
        expect.stringContaining('attachment; filename=pluralkit_export_test-sys_'),
      );
  ...
  describe('exportBackupZip', () => {
    it('should trigger backup ZIP export successfully', async () => {
      ...
      expect(jest.spyOn(mockRes, 'setHeader')).toHaveBeenCalledWith(
        'Content-Disposition',
        expect.stringContaining('attachment; filename=backup_system_'),
      );
