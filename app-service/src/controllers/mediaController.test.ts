...
describe('Media Controller', () => {
  ...
  describe('GET /download/:server/:mediaId', () => {
    it('should proxy successful downloads', async () => {
      ...
      const response = await request(app).get('/download/localhost/abcdef');
    ...
    it('should proxy Synapse error statuses', async () => {
      ...
      const response = await request(app).get('/download/localhost/notfound');
    ...
    it('should fail if AS_TOKEN is missing during download', async () => {
      ...
      const response = await request(app).get('/download/localhost/123');
