...
echo ""
echo "⚙️ INTEGRATION WITH AN EXISTING MATRIX HOMESERVER:"
echo "If you already run a Matrix homeserver via Docker Compose, you can integrate PluralMatrix."
echo "Please refer to the detailed integration guide for next steps:"
echo "👉 docs/INTEGRATING_EXISTING_HOMESERVER.md"
echo "--------------------------------------------------------"
